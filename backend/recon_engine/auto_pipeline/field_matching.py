...
* :func:`detect_roles_for_columns` — a Python port of
  ...
  Now defined in ``recon_engine.field_roles`` (shared with Manual mode) and
  re-exported here unchanged so existing imports keep working.
"""
...
# ROLE_ALIASES / detect_roles_for_columns now live in recon_engine.field_roles
